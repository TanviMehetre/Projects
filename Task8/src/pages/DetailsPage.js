...
function DetailsPage() {
        ...
        try {
            ...
            if (errorTimelog) {
                setValues({
                    ...
                    time_from: errorTimelog.time_from.slice(11, 16) || "",
                    time_to: errorTimelog.time_to.slice(11, 16) || "",
    ...
    return (
        ...
        >
            <Formik
                enableReinitialize={data?.status_code == 500 ? false : true}
                initialValues={{
                    timelog_id: id ?? "#",
                            ...
                            <Stack direction="row" alignItems="center" spacing={2}>
                                ...
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <DatePicker
                                        ...
                                        onChange={(date) => setFieldValue("entry_date", date)}
                                        onBlur={() => setFieldTouched("entry_date", true, true)}
                                        onClose={() => setFieldTouched("entry_date", true, true)}
                                        slotProps={{
                                            textField: {
                                                variant: "outlined",
                                                size: "small",
