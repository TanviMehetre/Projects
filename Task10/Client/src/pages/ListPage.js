...
function ListPage() {
    ...
    const showMessage = notification || response || (data?.status_code >= 201 && data?.message) || data?.error || location.state?.message;
            ...
            >
                <Stack direction="row" spacing={3} sx={{ mb: 1, maxWidth: 1300 }}>
                    <Stack direction="row" alignItems="center" spacing={1}>
                        <Typography sx={{ minWidth: 80, color: "white", pr: 1, textAlign: "center" }}>{intl.formatMessage({ id: "filter.projects" })}:</Typography>
                        <Autocomplete
                            disablePortal
                    ...
                    <Stack direction="row" alignItems="center" spacing={2}>
                        <Typography sx={{ minWidth: 80, color: "white", textAlign: "right", pr: 1 }}>{intl.formatMessage({ id: "filter.members" })}:</Typography>
                        <Autocomplete
                            disablePortal
                ...
                <Stack direction="row" spacing={3} sx={{ width: 1100 }}>
                    <Stack direction="row" alignItems="center" spacing={3} sx={{ textAlign: "right" }}>
                        <Typography sx={{ minWidth: 90, color: "white", maxWidth: 95 }}>{intl.formatMessage({ id: "filter.dateRange" })}:</Typography>
                        ...
                        <TableRow>
                            <TableCell align="center" sx={{ p: 0 }}>
                                <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", color: "white" }}>
                                    {intl.formatMessage({ id: "list.action" })}
                                    <AddCircleIcon sx={{ color: "yellow", ml: 1, cursor: "pointer" }} onClick={() => navigate("/create")} />
                                </Box>
                            </TableCell>
                            <TableCell sx={{ color: "white", borderBottom: "none" }}>{intl.formatMessage({ id: "list.name" })}</TableCell>
                            <TableCell sx={{ color: "white", borderBottom: "none" }}>{intl.formatMessage({ id: "list.date" })}</TableCell>
                            <TableCell sx={{ color: "white", borderBottom: "none" }}>{intl.formatMessage({ id: "list.project" })}</TableCell>
                            <TableCell sx={{ color: "white", borderBottom: "none" }}>{intl.formatMessage({ id: "list.task" })}</TableCell>
                            <TableCell sx={{ color: "white", borderBottom: "none" }}>{intl.formatMessage({ id: "list.timeFrom" })}</TableCell>
                            <TableCell sx={{ color: "white", borderBottom: "none" }}>{intl.formatMessage({ id: "list.timeTo" })}</TableCell>
                            <TableCell sx={{ color: "white", borderBottom: "none" }}>{intl.formatMessage({ id: "list.totalTime" })}</TableCell>
                            <TableCell sx={{ color: "white", borderBottom: "none" }}>{intl.formatMessage({ id: "list.notes" })}</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {showMessage && (
                            <TableRow>
                                <TableCell colSpan={100} align="center" sx={{ padding: 0, borderBottom: "none" }}>
                                    <Typography
                                        variant="body2"
                                        data-testid="filter-render"
                                ...
                                <React.Fragment key={employeeName}>
                                        ...
                                        <React.Fragment key={`${employeeName}-${date}`}>
                                                ...
                                                <TableRow key={log.timelog_id} sx={{ borderBottom: "none" }}>
                                                    <TableCell align="center" sx={{ borderBottom: "none" }}>
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <VisibilityRoundedIcon sx={{ color: "blue", mr: 1 }} /> {intl.formatMessage({ id: "list.view" })}
                                                            </MenuItem>
                                                            <MenuItem
                                                                onClick={() => {
                                                                    handleClose();
                                                            ...
                                                            >
                                                                <EditSquareIcon sx={{ color: "red", mr: 1 }} /> {intl.formatMessage({ id: "list.edit" })}
                                                            </MenuItem>
                                                        </Menu>
                                                    </TableCell>
                                                    ...
                                                    <TableCell sx={{ borderBottom: "none" }}>
                                                        ...
                                                        >
                                                            <Typography sx={{ p: 2, fontWeight: "bold", padding: "10px" }}>{intl.formatMessage({ id: "form.timeNote" })}</Typography>
                                            ...
                                            <TableRow sx={{ backgroundColor: "#6c757d", borderBottom: "none" }}>
                                                <TableCell colSpan={7} align="right" sx={{ color: "white" }}>
                                                    {intl.formatMessage({ id: "list.totalTimeForDate" }, { employeeName, date })}:
                                                </TableCell>
                                    ...
                                    <TableRow sx={{ backgroundColor: "#ffc107", borderBottom: "none" }}>
                                        <TableCell colSpan={7} align="right">
                                            {intl.formatMessage({ id: "list.totalTimeForEmployee" }, { employeeName })}:
                                        </TableCell>
